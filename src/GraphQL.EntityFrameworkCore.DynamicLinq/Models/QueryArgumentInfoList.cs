...
public class QueryArgumentInfoList : List<QueryArgumentInfo>
{
    ...
    {
        return new QueryArguments(this.Select(info => info.QueryArgument).OfType<QueryArgument>());
    }

    [PublicAPI]
    public QueryArgumentInfoList SupportOrderBy(string? orderByArgumentName = null)
    {
        if (!HasOrderBy)
        {
    ...
    [PublicAPI]
    public QueryArgumentInfoList SupportPaging(string? pageArgumentName = null, string? pageSizeArgumentName = null)
    {
        if (!HasPaging)
        {
            Add(new QueryArgumentInfo
    ...
    [PublicAPI]
    public QueryArgumentInfoList Include(params string[] includedGraphQLPropertyPaths)
    {
    ...
    [PublicAPI]
    public QueryArgumentInfoList Exclude(params string[] excludedGraphQLPropertyPaths)
    {
